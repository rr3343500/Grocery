...
public class BaseURL {
    ...
    public static String BASE_URL = "http://173.212.226.143/onhome/";  //     http://onhome.iwishtechnologies.com/
    ...
    public static String GET_SEARCH = BASE_URL + "index.php/api/get_products_suggestion";
